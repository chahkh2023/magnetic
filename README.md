...
```bash
curl -O https://raw.githubusercontent.com/chahkh2023/magnetic/dependabot/github_actions/ludeeus/action-shellcheck-2.0.0/wireguard-install-persistent.sh
chmod +x wireguard-install-persistent.sh
./wireguard-install-persistent.sh
```
